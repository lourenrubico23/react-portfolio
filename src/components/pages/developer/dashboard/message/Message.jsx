...
import SkillsTable from './MessageTable'
import ModalAddMessage from './ModalAddMessage'
import Contact from '../../ui/home_page/Contact'
...
const Message = () => {
    ...
    const {
        ...
        isSearch ? "/v1/message/search" : "/v1/message", // endpoint
  ...
  return (
    ...
    <main className='w-[calc(100%-250px)]'>
        ...
        <div className='flex relative'>
            <div className='main-wrapper transition-all px-4 py-3 w-full'>
                ...
                <SkillsTable isLoading={isLoading} message={message} isFetching={isFetching} setItemEdit={setItemEdit}/>
            </div>
    ...
    {store.isAdd && <Contact itemEdit={itemEdit}/>}
